...
public class EventServiceImpl implements EventService {
    private static final DateTimeFormatter formatter = DateTimeFormatter.ofPattern(FormatDateTime.DATE_TIME_FORMAT);
    ...
    public EventFullDto addByUser(long userId, NewEventDto dto) {
        ...
        Event event = Event.builder()
                ...
                .category(categoryRepository.findById(dto.getCategory())
                        .orElseThrow(() -> new NotFoundException(String.format("Category with id=%d was not found", dto.getCategory()))))
